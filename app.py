...
# 环境变量
UUID = os.environ.get('UUID', 'b401947b-1093-4a93-b86e-d08ee1a323e3')   # 节点UUID
...
PORT = int(os.environ.get('SERVER_PORT') or os.environ.get('PORT') or 8080)  # http和ws端口，默认自动优先获取容器分配的端口
